...
class _Implement:
    ...
    @staticmethod
    def get_original_name(func: TypstFunc):
    ...
    @staticmethod
    def is_temporary(func: TypstFunc):
        """Check whether a function is generated by function factories in module `customizations`.

        Args:
            func: The function to be checked.

        Returns:
            Whether a function is temporary.
        """
        return func in _Implement.temporary
...
def show_(
    ...
    def func(obj):
        if callable(obj):
            return _Implement.get_original_name(obj)
        return _render_value(obj)

    return f'#show {'' if element is None else func(element)}: {func(appearance)}'
